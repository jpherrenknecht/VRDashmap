...
//************************************************************************************************************
    ...
    function transmissionajax(message)
    {
        ...
        console.log('rank : '+Object.keys(message['last_seen_rank']))
        console.log('rank : '+(message['last_seen_rank']['rank']))
        console.log('Race_id'+Object.keys( message ['_id']))
        
        console.log ('Name = '+concat(message['displayName']))
...
function callRouterVRouteur  (race, userInfo, isMe, auto,currentTeam) {
    console.log ('La fonction callRouterVrouteur a ete appellee')
//     var host;
...
function callRouterlocal  (race, userInfo, isMe, auto,r) {

    var host;
    if (selRouter.value == 'local') {
        host = 'localhost:5000/patience';
    } else {
        host = 'localhost:5000/patience';
    }
